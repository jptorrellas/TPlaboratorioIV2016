...
.factory('urlFactory', function () {
	...
	var varWsPortada       	=  'portadaService.php';
	var varWsReporte       	=  'reporteService.php';
	...
	return {
 		...
 		wsPortada      	 : varServidor + varServices + varWsPortada,
 		wsReporte      	 : varServidor + varServices + varWsReporte
	}
});